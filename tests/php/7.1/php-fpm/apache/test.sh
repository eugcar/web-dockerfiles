...
function script_init() {
  readonly CONTAINER_NAME=php_fpm_apache_71_test
  ...
  readonly CONTAINER_TO_TEST=ecarocci/php-fpm-apache:7.1
...
function build_required_images() {
  ...
  build_image "${CONTAINER_TO_TEST}"    ./images/php/7.1/php-fpm/apache/Dockerfile
  cd -  > /dev/null 2>&1
}
